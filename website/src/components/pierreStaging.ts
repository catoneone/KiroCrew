...
/**
 * One-way "has this element come within a margin of the viewport" latch.
 * Environments without IntersectionObserver (jsdom) report near immediately,
 * so tests and degraded browsers keep the ungated behavior.
 */
export function useNearViewport<T extends Element>(
  margin: number = VIEWPORT_PRELOAD_MARGIN_PX,
