...
import { useNearViewport, useStagedMount } from './pierreStaging'
...
export const CodeBlock = memo(function CodeBlock(
  ...
  return (
    <div ref={nearRef as React.RefObject<HTMLDivElement>} className="code-block group/code rounded-xl border border-border bg-bg-elevated overflow-hidden">
