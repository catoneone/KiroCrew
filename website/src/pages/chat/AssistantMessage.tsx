  ...
  return <div data-role="assistant" className="group/msg">
    ...
    {!isStreaming && showFooter && (<>
      ...
      {/* Its own row below the hover actions on purpose: that row is a
          ...
          overflow actions live here. Share is always present; fork/plan
          appear only in their unavailable state (a loaded window keeps them
          as row buttons above, where the everyday controls belong). */}
      <div className={ACTIONS_REVEAL_CLS}>
        <DropdownMenu>
