...
/** Brand mark via lucide's Ghost glyph on a soft halo. Lucide renders as an
 *  in-DOM SVG element with no external fetch, so html-to-image captures it
 *  losslessly in the PNG export. */
function GhostMark() {
  return (
    <div
      aria-hidden="true"
    ...
    >
      <Ghost size={26} color="#f5f3ff" strokeWidth={2.2} />
    </div>
  )
}
